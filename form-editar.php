...
<body>
  ...
  <div class="col-sm-6 mb-3">
    ...
    <input type="text" class="form-control" name="edad" id="edad" placeholder="Ingresa tu Edad" value="<?php echo $fila['edad']; ?>" required>
  </div>
  <div class="col-sm-6 mb-3">
    <label for="fecha" class="form-label">* fecha de nacimiento</label>
    <input type="date" class="form-control" name="fecha" id="fecha" placeholder="Ingresa tu fecha de nacimiento" value="<?php echo $fila['fecha']; ?>" required>
  </div>
  <div class="col-sm-6 mb-3">
  ...
  <div class="col-sm-6 mb-3">
    ...
    <input type="text" class="form-control" name="pass" id="pass" placeholder="Ingresa una clave de 8 caracteres como mínimo" value="<?php echo md5($fila['clave']); ?>" required>
  </div>    
