...
<div class="container mt-2 mb-5">
  <div class="text-center mt-5 mb-2"><h2>Editar datos de las especies</h2></div>	
  <br>
   <br>
  ...
  <div class="col-sm-6">
    ...
    <input type="text" class="form-control" name="num" id="mun" placeholder="" value="<?php echo $fila['num']; ?>" required>
  </div>
  <div class="col-sm-6">
    <label for="nombre" class="form-label">* Especie</label>
    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Editar el Nombre de la especie" value="<?php echo $fila['nombre']; ?>" required>
  </div>
  <div class="col-sm-6 mb-3">
    <label for="apellido" class="form-label">* Estado de conservación</label>
    <input type="text" class="form-control" name="apellido" id="estado" placeholder="Ingresa su estado de conservación" value="<?php echo $fila['estado']; ?>" required>
  </div>
   <div class="col-sm-6 mb-3">
    <label for="fecha" class="form-label">* Fecha de ingreso</label>
    <input type="date" class="form-control" name="fecha" id="fecha" placeholder="Ingresa fecha de ingreso" value="<?php echo $fila['fecha']; ?>" required>
  </div>
  
    <div class="col-sm-6 mb-3">
    <label for="donante" class="form-label">* Donante</label>
    <input type="text" class="form-control" name="donante" id="donante" placeholder="Ingresa tu Correo Electrónico" value="<?php echo $fila['email']; ?>" required>
  </div>

  <div class="col-sm-6 mb-3">
    <label for="clasificacion" class="form-label">* Clasificación</label>
    <input type="text" class="form-control" name="clasificacion" id="clasificacion" placeholder="Ingresa su clasificacion" value="<?php echo $fila['email']; ?>" required>
  </div>
  <div class="col-sm-6 mb-3">
